...
$("html").css(
  "background",
  "linear-gradient(90deg, #aabce8, #cfc6e5, #e2c6e6)"
);
...
$([
  "access/icons/docac.svg",
  "access/icons/posin.svg",
  "access/icons/posac.svg",
  "access/icons/docin.svg",
  "access/icons/notin.svg",
  "access/icons/notac.svg",
  "access/icons/menuin.svg",
  "access/icons/menuac.svg",
  "access/icons/qrcodeinc.png",
  "access/icons/qrcodeact.png",
  "access/icons/shtrihinc.png",
  "access/icons/shtrihact.png",
  "access/icons/1.svg",
  "access/icons/2.svg",
  "access/icons/3.svg",
  "access/icons/4.svg",
  ...
  "access/icons/10.svg",
  "access/icons/11.svg",
  "access/icons/arrow.svg",
  "access/e-Ukraine-Regular.woff",
]).preload();
...
setTimeout(function () {
  ...
  setTimeout(function () {
    ...
    setTimeout(function () {
      ...
      setTimeout(function () {
        var ves =
          ($(".papage > .footer").height() -
            $(".papage > .footer > .ft_icons").height()) /
          2;
...
if (
  ...
  if (navigator.userAgent.match(/Android/)) {
    document.getElementsByClassName("okimg")[0].style.backgroundImage =
      "url(access/icons/ok2.png)";
  }
  if (isInWebAppiOS == false && isInWebAppChrome == false) {
    isWorking = false;
    $("body").html(
      '<div class="nonono">Для айфона<br>Нажмите "поделиться", а затем "На экран Домой"<br>Для андроида<br>Нажмите по трем точкам в браузере и добавьте эту страницу на главный экран<br></div>'
    );
  ...
  isWorking = false;
  $("body").html(
    '<body class="nononopage"><div class="nonono installTutorial" style="width: 100%;padding: 1vh;display: flex;flex-wrap: wrap;justify-content: center;"><div class="installPage" style="text-align: center;padding: 15px;"><div class="installName" style="font-size: 20px;font-weight: 600;">Сайт доступен</div><p>Только с мобильных устройств</p></div></div>'
  );
  $("body").addClass("nononopage");
}
